...
- Focused docs and generator-cleanup suite passed: 3 files, 53 tests.
- Canonical `npm run verify` passed: 157 test files and 2,144 tests, plus backend TypeScript, CLI, SDK, external SDK fixture, legacy frontend lint/build, and canonical Next.js build.
