...
const ManualAnnouncementJsonSchema = zodToJsonSchema(ManualAnnouncementSchema, {
  target: 'jsonSchema7',
});
  ...
  app.get(
    '/api/bot/status',
    {
      schema: {
        ...
        summary: 'Bot status',
        description:
          'Returns bot status including enabled state, bot DID, current pinned announcement, and retry queue length.',
  ...
  app.post(
    '/api/bot/announce',
    {
      schema: {
        ...
        description:
          'Posts a manual announcement as the bot account on Bluesky. Requires admin DID.',
        security: adminSecurity,
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      ...
      try {
        ...
        logger.info(
          { adminDid: requesterDid, announcementId: announcement?.id },
        ...
        querystring: {
          ...
          properties: {
            limit: {
              ...
              maximum: 50,
              default: 10,
              description: 'Max announcements to return',
            },
          },
        },
        response: {
  ...
  app.post(
    '/api/bot/retry',
    {
      schema: {
        ...
        description:
          'Processes the announcement retry queue, attempting to repost any failed announcements. Requires admin DID.',
        security: adminSecurity,
        response: {
          200: {
            type: 'object',
  ...
  app.delete(
    '/api/bot/retry',
    {
      schema: {
        ...
        description:
          'Clears the announcement retry queue, discarding all pending retries. Requires admin DID.',
        security: adminSecurity,
        response: {
          200: {
            type: 'object',
