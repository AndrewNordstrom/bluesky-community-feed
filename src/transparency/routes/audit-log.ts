...
function redactDetails(
  ...
  const hasWeights =
    asRecord(safeDetails.weights) !== null || asRecord(safeDetails.original_weights) !== null;
              ...
              entries: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    action: {
                      type: 'string',
                      description: 'Action type (e.g. vote_cast, epoch_created)',
                    },
                    actor_did: {
                      type: 'string',
                      nullable: true,
                    ...
                    details: {
                      ...
                      description: 'Action-specific details (vote details redacted)',
                    },
