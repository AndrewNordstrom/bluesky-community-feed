  ...
  app.get(
    '/xrpc/app.bsky.feed.describeFeedGenerator',
    {
      schema: {
        ...
        description:
          'Returns the DID and feed URIs for this generator. Called by Bluesky for feed discovery.',
        response: {
          200: {
            type: 'object',
            properties: {
              did: {
                type: 'string',
                description: 'Service DID for this feed generator',
                example: 'did:web:feed.corgi.network',
              },
              feeds: {
                type: 'array',
                items: {
                  ...
                  properties: {
                    uri: {
                      ...
                      example: 'at://did:plc:example/app.bsky.feed.generator/community-gov',
                    },
                  },
                  required: ['uri'],
                },
