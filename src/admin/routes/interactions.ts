...
export function registerInteractionRoutes(app: FastifyInstance): void {
  ...
  app.get(
    ...
    async (_request: FastifyRequest, reply: FastifyReply) => {
      ...
      `);
        ...
        return reply
          .code(500)
          .send({ error: 'InternalError', message: 'Failed to get interaction overview' });
      }
    },
  );
  ...
  app.get(
    '/interactions/scroll-depth',
    {
      schema: {
        ...
        description:
          'Returns a histogram of scroll depth by session for the last 7 days, bucketed by page count.',
        security: adminSecurity,
        response: {
          200: {
            type: 'object',
              ...
              histogram: {
                ...
                items: {
                  ...
                  properties: {
                    bucket: {
                      type: 'string',
                      description: 'Depth bucket label (e.g. "1 page", "2-3 pages")',
                    },
    ...
    async (_request: FastifyRequest, reply: FastifyReply) => {
      ...
      `);
        ...
        return reply
          .code(500)
          .send({ error: 'InternalError', message: 'Failed to get scroll depth' });
      }
    },
  );
  ...
  app.get(
              ...
              byPosition: {
                ...
                items: {
                  ...
                  properties: {
                    bucket: {
                      type: 'string',
                      description: 'Position bucket (e.g. "Top 10", "11-25")',
                    },
                    served: { type: 'integer' },
    ...
    async (_request: FastifyRequest, reply: FastifyReply) => {
      ...
      `);
        ...
        return reply
          .code(500)
          .send({ error: 'InternalError', message: 'Failed to get engagement stats' });
      }
    },
  );
   ...
   */
  app.get(
    '/interactions/epoch-comparison',
    {
      schema: {
        tags: ['Admin'],
        summary: 'Epoch engagement comparison',
        description:
          'Returns engagement stats across all epochs for chart rendering, including feed loads, viewers, and engagement rates.',
        security: adminSecurity,
        response: {
          200: {
            type: 'object',
    ...
    async (_request: FastifyRequest, reply: FastifyReply) => {
      ...
      `);
        ...
        return reply
          .code(500)
          .send({ error: 'InternalError', message: 'Failed to get epoch comparison' });
      }
    },
  );
   ...
   */
  app.get(
    '/interactions/keyword-performance',
    {
      schema: {
        tags: ['Admin'],
    ...
    async (_request: FastifyRequest, reply: FastifyReply) => {
      ...
      `);
        ...
        const contentRules = rulesResult.rows[0]?.content_rules ?? {
          include_keywords: [],
          exclude_keywords: [],
        };
        ...
        return reply
          .code(500)
          .send({ error: 'InternalError', message: 'Failed to get keyword performance' });
      }
    },
  );
  ...
  app.get(
    ...
    async (_request: FastifyRequest, reply: FastifyReply) => {
      ...
      `);
        ...
        return reply
          .code(500)
          .send({ error: 'InternalError', message: 'Failed to get feed signal analytics' });
      }
    },
  );
