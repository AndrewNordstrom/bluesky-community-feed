  ...
  app.get(
    '/health',
    {
      schema: {
        ...
        description:
          'Returns detailed health status for all system components (database, Redis, Jetstream, scoring). Requires admin access.',
                ...
                properties: {
                  ...
                  jetstream: {
                    ...
                    properties: {
                      ...
                      connected: {
                        type: 'boolean',
                        description: 'Whether the WebSocket is connected',
                      },
                      last_event_age_ms: {
                        type: 'number',
                        description: 'Age of the last received event in ms',
                      },
                      error: { type: 'string' },
                    },
                  ...
                  scoring: {
                    ...
                    properties: {
                      ...
                      is_running: {
                        type: 'boolean',
                        description: 'Whether a scoring run is in progress',
                      },
                      last_run_at: {
                        type: 'string',
                        format: 'date-time',
                        description: 'ISO 8601 timestamp of last scoring run',
                      },
                      error: { type: 'string' },
                    },
